...
elif '<link rel="stylesheet" href="styles.css?v=20260818_2">' in html:
    html = html.replace('<link rel="stylesheet" href="styles.css?v=20260818_2">', css_tag)

# Find script block and inline JS
start_marker = "<!-- NMC Application JavaScript Unified Bundle -->"
end_marker = '<script src="js/app.js"></script>'
